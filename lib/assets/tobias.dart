...
class Tobias extends StatefulWidget {
  const Tobias({super.key});

  @override
  State<Tobias> createState() => _TobiasState();
}

class _TobiasState extends State<Tobias> {
  ...
  Future<void> fetchData() async {
    ...
    if (response.statusCode == 200) {
      ...
      print(companies);
      final companyId = companies[1]['id'];
      try {
    ...
    return Theme(
      ...
      child: ListView(
        children: locations
            ...
            .map((location) => buildLocationNode(location))
